...
_WELCOME = (
    ...
    "/reset — очистить очередь email для рассылки (лоты в БД остаются)\n"
    "/stop — остановить рассылку\n"
    "/stat — статус рассылки\n"
    "/imap_diag — входящие почта/IMAP\n"
    "/stoppodbor — остановить подбор email (сохранит найденное в БД)\n\n"
    "Чтобы начать валидацию email — просто пришли сюда JSON-файл с объявлениями.\n"
    "Во время подбора можно /stoppodbor — валидные email попадут в БД и в /send, если рассылка уже идёт.\n\n"
